...
from zorg.kupusupport.interfaces import IImageLibraryInfo
...
class KupuEditor(BrowserView):
    ...
    Preparation::
        ...
        >>> from zorg.kupusupport.sample.adapters import KupuSamplePolicy
...
class ImageLibraryInfo(BrowserView):
    ...
    # implementation of zorg.kupusupport.IImageLibraryInfo

...
The table package provides tabular data handling by using schema information.
    ...
    >>> from table.testing import ISimple,Simple,Container
    >>> container = Container()
    >>> for i in range(5):
    ...
    [<table.testing.Simple object at ...>]

    XXX The ITableConfig utility registration should be done in zcml.

    >>> from table.table import Column,TableConfig
    >>> from table.interfaces import ITable,ITableConfig
    ...
    >>> print config
    <table.table.TableConfig object at ...>
    ...
    >>> print table
    <table.table.ReadMappingTable object at ...>
    ...
    >>> print list(table.getColumns())
    [<table.table.Column object at ...>, <table.tab...>]

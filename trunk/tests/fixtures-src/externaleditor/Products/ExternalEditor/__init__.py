...
misc_ = {'edit_icon': ImageResource('edit_icon.gif', globals())}
...
ObjectManager.manage_main = DTMLResource('manage_main', globals())

# Add our patch for the find results template
FindSupport.manage_findResult=DTMLResource('findResult', globals(),

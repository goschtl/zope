...
class IFormAPI(interface.Interface):
    """API to facilitate creating forms, provided by zc.page.form
    """
    ...
    def Action(label, **options):
        ...
        validator
          ...
          list of errors.  It may also return None to behave as if the
          action wasn't submitted.
    ...
    def action(label, **options):
        ...
        This function creates a factory for creating a action from a
    ...
    def validate(form, actions, form_prefix, data, default_validate=None):
        ...
        If a action was submitted, then validate the input.  The input
        ...
        If a action was submitted, then the function returns the
    ...
    FormBase = interface.Attribute("""Base class for creating fors
...
class IFormBaseCustomization(ISubPage, IPage):
    ...
    def validate(action, data):
        ...
        If a action is submitted and the action doesn't have it's own
...
class IAction(ISubPage):
    ...
    validator = interface.Attribute(
        ...
        This is a callable object that will be passed a form and an
        action and that returns a (possibly empty) list of errors.
    ...
    def validate(data):
        ...
        the validator result is returned. Otherwise, None is retirned.
...
class IActions(interface.Interface):
    ...
    def __getitem__(name):
        ...
        form field used to create a action has a prefix, then that
        should be reflected in the name passed.
        """

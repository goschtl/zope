...
##############################################################################
"""
$Id: test_adapters.py,v 1.1 2004/01/16 12:39:04 philikon Exp $
"""
...
from zope.products.statictree.interfaces import IUniqueId, \
     IChildObjects, ITreeStateEncoder
from zope.products.statictree.utils import TreeStateEncoder
from zope.products.statictree.adapters import StubUniqueId, \
     StubChildObjects, LocationUniqueId, ContainerChildObjects, \
     ContainerSiteChildObjects

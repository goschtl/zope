...
$Id: __init__.py,v 1.1 2004/01/29 17:51:18 srichter Exp $
"""
from zope.app import zapi
from zope.app.interfaces.location import ILocation
from zope.interface import implements
from zope.products.apidoc.interfaces import IDocumentationModule
from zope.products.apidoc.utilities import ReadContainerBase, getPythonPath
...
class UtilityInterface(ReadContainerBase):
    ...
    Demonstration::
      ...
      >>> from zope.products.apidoc.utilitymodule import tests
      >>> from zope.products.apidoc.interfaces import IDocumentationModule
      >>> tests.setUp()

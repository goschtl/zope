...
$Id: tests.py,v 1.1 2004/01/29 17:51:18 srichter Exp $
"""
import unittest
...
from zope.products.apidoc.classmodule import ClassModule
...
def test_suite():
    return unittest.TestSuite((
        DocTestSuite('zope.products.apidoc.utilitymodule'),
        ))

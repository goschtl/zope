...
$Id: testI18nImage.py,v 1.1 2002/06/25 10:54:24 mgedmin Exp $
"""
...
class Test(TestII18nAware):
    ...
    def _makeImage(self, *args, **kw):
        """ """
        from Zope.App.OFS.Content.Image.I18nImage import I18nImage
    ...
    def testInterface(self):
        ...
        from Zope.App.OFS.Content.Image.I18nImage import I18nImage
        from Zope.App.OFS.Content.File.I18nFile import II18nFile

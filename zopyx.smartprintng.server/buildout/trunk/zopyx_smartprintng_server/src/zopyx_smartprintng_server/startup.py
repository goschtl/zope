...
def interactive_debug_prompt(zope_conf='/home/develop/repository/svn.zope.org/zopyx.smartprintng.server/buildout/trunk/zopyx_smartprintng_server/etc/zope.conf'):
...
def zdaemon_controller(zdaemon_conf='/home/develop/repository/svn.zope.org/zopyx.smartprintng.server/buildout/trunk/zopyx_smartprintng_server/etc/zdaemon.conf'):
